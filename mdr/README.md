# MDR (a Golang package to parse and give out usable information about .rofl files)

MDR is a Golang package that allows you to parse .rofl files (League of Legends replay files) and extract useful information from them. It provides functionality to read the binary structure of .rofl files and retrieve metadata such as match details, player information, and game events.
